...
const PieChart = ({
  ...
  }, values.map((fill, index) => React.createElement("div", {
    className: "k-pie-chart__label",
    key: index
  }, React.createElement("span", {
    className: "k-pie-chart__legend"
  }), React.createElement("h4", {
    className: "k-pie-chart__number"
  }, fill.value, React.createElement("small", null, "%")), React.createElement("div", null, React.createElement("h5", {
    className: "k-pie-chart__title"
  }, fill.title), React.createElement("p", null, fill.text))))));
};
