...
const Quote = ({ text, headshot, person, border, link, isLarge, noPadding, extraClasses }) => React.createElement(
    'div',
    ...
    React.createElement(
        ...
        headshot && React.createElement('img', { 'class': 'k-quote__headshot', src: headshot }),
        React.createElement(
            'div',
